...
<?php
	...
	**************************************************************************/
	...
	if ($_SERVER['REQUEST_METHOD'] == "GET") {
		...
		$error_message = "Descriptions can be a maximum of 100 characters long.";
	}
	else if ($cruise_id < 1) {
	...
	**************************************************************************/
	if ($_SERVER['REQUEST_METHOD'] == "POST" AND $error_message == "") {
		...
		echo "<h2> Data was entered Successfully! </h2> <br><br><br><br><br>";
		...
		$q = "INSERT INTO T18_Cabins (cabin_type, cabin_price, cabin_availability, cabin_description, cabin_deck, cruise_ID, image_file, cabin_active)" . 
				"VALUES('$type', $price, '$availability', '$description', '$deck', $cruise_id, '$image', '$active');";
