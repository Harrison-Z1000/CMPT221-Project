...
<table border = 1>
  <tr>
    ...
    <td style="background-color: rgb(0,0,0,.4); color: white">
		<h2>Enjoy a day on the Sunseeker 88 Cruise! You can rent the Sunseeker for a day
			on the Great South Bay (with proper license). Enjoy everything the
			Great South Bay has to offer by trying:
			<br></br>- Water Tubing<br></br>- Water Skiing<br></br>- Sunset Watching For The Whole Family<br></br>- And Much More!</h2></td>
  </tr>
