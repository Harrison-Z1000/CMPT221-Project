...
<h2> Change Log </h2>
	<p style="padding: 20px; margin: 15px; text-align: center; color: white;"> 
		<br> V1.0 Initial Page created. 16-Sep-2020 <br>
		...
		<br> V2.1 All tables have the function to add and deactivate rows. 17-Nov-2020 <br>
		<br> V2.2 All tables now have the option to sort the table based on user active. 26-Nov-2020 <br>
		<br> V2.3 Add row function now checks for duplicate entries. 2-Dec-2020 <br>
		<br> V3.0 Login Function has been implemented. 3-Dec-2020 <br>
		<br> V4.0 Navigation Bar changes based on login status - Log Out function also implemented. 4-Dec-2020 <br>
	</p>
<br><br><br><br>
<hr>
<?php 
